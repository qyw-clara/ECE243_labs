...
_start:        
                ...
                MOV	R1, #0b11010010 //set up stack pointer for IRQ
				MSR	CPSR_c, R1
				LDR	SP, =0x40000
				
				MOV R1, #0b11010011 //set up stack pointer for SVC
				MSR	CPSR_c, R1
				LDR	SP, =0x20000
...
KEY_ISR:
				...
				AND	R2, #0b1000
				CMP	R2, #0b1000
				MOVEQ R4, #0b01001111	//3 ON HEX3
				LSLEQ R4, #24
				EOREQ R3, R4
				POP {R2}
				
				STR	R3, [R1]	//show numbers on hex
